...
from .utils import chunk_text_with_metadata, initialize_bm25, append_to_response
...
"""
        try:
            ...
            append_to_response([{"expand_query_rag_system":response}], filename="check_LLM_cost.json")
...
7.  **Always answer in English, regardless of the input language. 
...
**ANALYST'S ANSWER:**"""
        ...
        append_to_response([{"answer_query_rag_system":response}], filename="check_LLM_cost.json")
